...
const seededSubmissions = [
  { id: 'first', fullName: 'Alex Morgan', email: 'alex@example.com', mobile: '9876543210', department: 'Engineering', submittedAt: '2026-03-04T00:00:00.000Z' },
  { id: 'second', fullName: 'Jamie Reed', email: 'jamie@example.com', mobile: '9876543211', department: 'Design', submittedAt: '2026-03-06T00:00:00.000Z' },
];

/** Renders the protected route with a real browser-storage boundary. */
function renderAdmin() {
  return render(<BrowserRouter><AdminPage /></BrowserRouter>);
}
...
describe('AdminPage', () => {
  ...
  it('validates and persists an editable record, retains read-only email, then deletes after confirmation', async () => {
    ...
    expect(JSON.parse(window.localStorage.getItem(SUBMISSIONS_KEY))[0]).toMatchObject({ mobile: '9123456789', department: 'Data Science', email: 'alex@example.com' });
